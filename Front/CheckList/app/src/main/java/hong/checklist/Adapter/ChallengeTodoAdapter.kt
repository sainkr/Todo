...
import hong.checklist.DB.ChallengeContents
import hong.checklist.DB.TodoContents
import hong.checklist.Listener.OnCheckListener
import hong.checklist.R
import kotlinx.android.synthetic.main.item_checklist.view.*

class ChallengeTodoAdapter(val context : Context?, var list : List<ChallengeContents>, var onCheckListener: OnCheckListener) : RecyclerView.Adapter<ChallengeTodoAdapter.MyViewHolder>(){
